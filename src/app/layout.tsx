      ...
      <head>
        ...
        <JsonLd
          data={{
            ...
            '@type': 'WebApplication',
            name: 'Your Name in the Stars',
            url: BASE_URL,
            description:
              'Type your name and see your name in the stars using real stars from our intergalactic star database. Name a star for free online.',
