...
export default function NameInput({
  ...
  return (
    <>
      ...
      >
        <div
          className="flex items-center gap-2 p-1.5 rounded-xl border w-full bg-white/5 backdrop-blur-md shadow-lg"
        ...
        >
          ...
          <input
            ...
            maxLength={16}
            className="flex-1 bg-transparent text-gray-200 text-base px-4 py-2 outline-none placeholder-gray-500 font-sans tracking-wide"
            autoFocus
          />
          ...
          <button
            ...
            className="px-5 py-2 rounded-lg text-sm font-semibold transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed bg-white/10 hover:bg-white/20 text-gray-200 shadow-sm"
          >
            {isLoading ? (
          ...
          >
            {isDownloading ? (
              <span className="inline-block w-5 h-5 border-2 border-gray-400 border-t-white rounded-full animate-spin" />
            ) : (
              <svg
                width="20"
                height="20"
        ...
        <p className="text-center text-gray-500 text-xs mt-3 font-sans tracking-wide">
